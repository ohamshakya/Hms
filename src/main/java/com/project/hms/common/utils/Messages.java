...
public class Messages {
    ...
    public static final String APPOINTMENT_ADDED_SUCCESSFULLY = "APPOINTMENT CREATED SUCCESSFULLY";
    public static final String APPOINTMENT_UPDATED_SUCCESSFULLY = "APPOINTMENT UPDATED SUCCESSFULLY";
    public static final String APPOINTMENT_RETRIEVED_SUCCESSFULLY = "APPOINTMENT RETRIEVED SUCCESSFULLY";
    public static final String APPOINTMENT_DELETED_SUCCESSFULLY = "APPOINTMENT DELETED SUCCESSFULLY";
    public static final String APPOINTMENT_NOT_FOUND = "APPOINTMENT NOT FOUND";

    public static final String PRESCRIPTION_ADDED_SUCCESSFULLY = "PRESCRIPTION CREATED SUCCESSFULLY";
    public static final String PRESCRIPTION_UPDATED_SUCCESSFULLY = "PRESCRIPTION UPDATED SUCCESSFULLY";
    public static final String PRESCRIPTION_RETRIEVED_SUCCESSFULLY = "PRESCRIPTION RETRIEVED SUCCESSFULLY";
